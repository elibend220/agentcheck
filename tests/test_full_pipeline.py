...
def test_pipeline_llm_call_count():
    ...
    llm = FakeLLM()
    coordinator = AgentCoordinator(llm, enable_phase4=False, enable_phase6=False, enable_phase7=False, enable_phase8=False, enable_phase9=False, enable_phase10=False)
    ...
    # Without Phase 4, 6, 7, 8, 9, and 10: Phase 1, 2, 3a, 3b, 3c = 5 nodes
